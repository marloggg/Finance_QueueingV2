...
$sql = "SELECT * FROM enrollment WHERE status = 2 AND DATE(date_created) = '$current_date' ORDER BY queue ASC LIMIT 9";
...
$sql = "SELECT COUNT(*) as num_rows FROM enrollment WHERE status = 2 AND DATE(date_created) = '$current_date'";
$result = $conn->query($sql);
...
if ($num_rows > 9) {
    ...
    $sql = "SELECT * FROM enrollment WHERE status = 2 AND DATE(date_created) = '$current_date' ORDER BY queue DESC LIMIT 1";
    $result = $conn->query($sql);
