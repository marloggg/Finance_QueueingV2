...
<div class="container-fluid">
    <form action="" id="cashier-form">
        ...
        <div class="form-group">
            ...
            <input type="text" name="username" autofocus id="username" required class="form-control form-control-sm rounded-0" value="<?php echo isset($username) ? $username : '' ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="email_address" autofocus id="email_address" required class="form-control form-control-sm rounded-0" value="<?php echo isset($email_address) ? $email_address : '' ?>">
        </div>
        <div class="form-group">
            <label for="password" class="control-label">Password</label>
            <input type="password" name="password" autofocus id="password" required class="form-control form-control-sm rounded-0" value="<?php echo isset($password) ? $password : '' ?>">
        </div>
        <div class="form-group">
...
<script>
    $(function(){
        $('#cashier-form').submit(function(e){
            ...
            $.ajax({
                url:'./sa_actions.php?a=save_cashier',
                method:'POST',
                data:$(this).serialize(),
                dataType:'JSON',
                error:err=>{
