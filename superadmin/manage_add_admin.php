...
<div class="container-fluid">
    <form action="" id="user-form">
        ...
        <div class="form-group">
            <label for="username" class="control-label">Employee # </label> <label style="font-size: 12px;"><i>(This will be used as the username)</i></label>
...
<script>
    $(function(){
        $('#user-form').submit(function(e){
            ...
            $.ajax({
                url:'./sa_actions.php?a=save_add_admin',
                method:'POST',
                data:$(this).serialize(),
                dataType:'JSON',
                error:err=>{
