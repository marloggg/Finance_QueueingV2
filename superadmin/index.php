    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-gradient" id="topNavBar">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'users')? 'active' : '' ?>" aria-current="page" href="././?page=users">Administrators</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'cashiers')? 'active' : '' ?>"aria-current="page" href="./?page=cashiers">Cashier List</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li><a class="dropdown-item" href="./sa_actions.php?a=sa_logout">Logout</a></li>
                </ul>
            </div>
            </div>
        </div>
