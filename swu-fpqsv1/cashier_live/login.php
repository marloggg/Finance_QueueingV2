...
<body class="bg-dark bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       ...
       <img src="./swu.png" alt="SWU Phinma Logo" width="200" height="200"></center>
                ...
                <form action="" id="login-form">
                    ...
                    <div class="form-group">
                        ...
                        <select name="cashier_id" id="cashier_id" data-placeholder="Please Select Cashier to Operate" class="custom-select2 select2">
                            ...
                            <?php 
                            $cashier = $conn->query("SELECT * FROM `cashier_list` where `status` = 1 order by `lastname` asc");
                            while($row = $cashier->fetchArray()):
                            ?>
                                <option value="<?php echo $row['cashier_id'] ?>"><?php echo $row['lastname'] ?></option>
                            <?php endwhile; ?>
                        </select>
                    <div class="form-group">
                    ...
                    <div class="form-group d-flex w-100 justify-content-between align-items-center">
                        <span>
                       <?php //<a href="forgot.php">Forgot password?</a> ?>
                        </span>
