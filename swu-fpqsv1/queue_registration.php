...
<body>
    ...
    <?php
        ...
        $futureTime = strtotime('+6 hours', $currentTime); // Adding 6 hours to the current time
        
        $date = date("H:i", $futureTime); 
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="card rouded-0 shadow">
                            ...
                            <div class="card-header rounded-0">
                                <div class="h5 card-title"><center>Get your RAD Queue Number Here.</center></div>
                            </div>
                            <div class="card-body rounded-0">
                                <form action="" id="queue-form">
                                    <div class="form-group">
                                        <label for="customer_name" class="control-label text-info" style="display:none" >Enter your Name</label>
                                        <input type="text" id="customer_name" name="customer_name" autofocus autocomplete="off" class="form-control form-control-lg rounded-0 border-0 border-bottom" type="submit" required value="ivan jay almeria" style="display:none" >
                                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-7">
                        ...
                        <div class="card rouded-0 shadow">
                            ...
                            <div class="card-header rounded-0">
                                <div class="h5 card-title"><center>Get your LIVE Queue Number Here.</center></div>
                            </div>
                            <div class="card-body rounded-0">
                                <form action="" id="queue-form-liv">
                                    <div class="form-group">
                                        <label for="customer_name" class="control-label text-info" style="display:none" >Enter your Name</label>
                                        <input type="text" id="customer_name" name="customer_name" autofocus autocomplete="off" class="form-control form-control-lg rounded-0 border-0 border-bottom" type="submit"  required value="ivan jay almeria" style="display:none" >
                                    </div>
    ...
    <script>
        ...
        $(function(){
            $('#queue-form-liv').submit(function(e){
                e.preventDefault()
                var _this = $(this)
                _this.find('.pop-msg').remove()
                var el = $('<div>')
