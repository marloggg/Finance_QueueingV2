...
<div class="container-fluid">
    <form action="" id="student-form">
        ...
        <div class="form-group">
            ...
            <input type="text" name="student_course" autofocus id="student_course" required class="form-control form-control-sm rounded-0" value="<?php echo isset($student_course) ? $student_course : '' ?>">
        </div>
    </form>
</div>
...
<script>
    $(function(){
        $('#student-form').submit(function(e){
            ...
            $.ajax({
                url:'./sa_actions.php?a=update_student',
                method:'POST',
                data:$(this).serialize(),
                dataType:'JSON',
                error:err=>{
