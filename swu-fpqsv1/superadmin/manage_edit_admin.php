...
if(isset($_GET['id'])){
$qry = $conn->query("SELECT * FROM `administrator_list` where admin_id = '{$_GET['id']}'");
...
<div class="container-fluid">
    <form action="" id="user-form">
        ...
        <div class="form-group">
            ...
            <input type="text" name="old_password" id="old_password" required class="form-control form-control-sm rounded-0"value="<?php echo isset($password) ? $password : '' ?>"readonly>
        </div>
        <div class="form-group">
...
<script>
    $(function(){
        $('#user-form').submit(function(e){
            ...
            $.ajax({
                url:'./sa_actions.php?a=update_Acredentials',
                method:'POST',
                data:$(this).serialize(),
                dataType:'JSON',
                error:err=>{
