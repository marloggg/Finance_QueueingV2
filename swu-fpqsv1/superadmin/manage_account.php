...
$qry = $conn->query("SELECT * FROM `superadmin_list` where superadmin_id = '{$_SESSION['superadmin_id']}'");
...
<div class="col-md-6">
    <form action="" id="user-form">
        <input type="hidden" name="id" value="<?php echo isset($superadmin_id) ? $superadmin_id : '' ?>">
...
<script>
    $(function(){
        $('#user-form').submit(function(e){
            ...
            $.ajax({
                url:'./sa_actions.php?a=update_SAcredentials',
                method:'POST',
                data:$(this).serialize(),
                dataType:'JSON',
                error:err=>{
