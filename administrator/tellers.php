        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center p-0">Terminal Number</th>
            ...
            <tbody>
                <?php 
                $sql = "SELECT * FROM `teller_list`  order by `teller_name` asc";
                $qry = $conn->query($sql);
                $i = 1;
...
<script>
    ...
    function delete_data($id){
        ...
        $.ajax({
            url:'./Actions.php?a=delete_teller',
            method:'POST',
            data:{id:$id},
            dataType:'JSON',
            error:err=>{
            ...
            success:function(resp){
                if(resp.status == 'success'){
                    ...
                    //alert("An error occurred.")
                    alert("You cannot delete this cashier. This teller still has records at this system. If you want to delete this teller you should go to CASHIER LOGS and EXPORT TO CSV AND CLEAR LOGS first.")
                }
                $('#confirm_modal button').attr('disabled',false)
