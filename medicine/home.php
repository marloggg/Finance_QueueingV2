        ...
        <div class="col-md-6 d-flex flex-column justify-content-center align-items-center" id="serving-field">
            <div class="card col-sm-8 shadow">
                <div class="card-header">
                    <h5 class="card-title text-center">Now Serving MEDICINE</h5>
                </div>
                <div class="card-body">
...
<script>
    ...
    function get_queue(){
        $.ajax({
            url:'./../Actions.php?a=next_medicine',
            dataType:'json',
    ...
    function queue(){
        ...
        websocket.send(JSON.stringify({type:'medicine',cashier_id:'<?php echo $_SESSION['teller_id'] ?>',qid:in_queue.queue_id}))
    }
